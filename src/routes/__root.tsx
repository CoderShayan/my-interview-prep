...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PrepDesk — Your personal interview prep" },
      { name: "description", content: "A private workspace to prepare for your interviews: question bank, AI mock interviews, notes, and progress tracking." },
    ],
